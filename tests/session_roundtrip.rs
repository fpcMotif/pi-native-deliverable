...
fn session_jsonl_roundtrip_semantics() {
    ...
    let entries = vec![
        r#"{"schema_version":"1.0","entry_id":"00000000-0000-0000-0000-000000000001","timestamp_ms":12345,"kind":{"kind":"user_message","text":"hello"},"parent_id":null,"metadata":null}"#,
        r#"{"schema_version":"1.0","entry_id":"00000000-0000-0000-0000-000000000002","timestamp_ms":12346,"kind":{"kind":"assistant_message","text":"hi"},"parent_id":"00000000-0000-0000-0000-000000000001","metadata":null}"#,
    ];
    ...
    assert_eq!(
        pi_protocol::session::normalize_jsonl(&raw).unwrap(),
        pi_protocol::session::normalize_jsonl(&roundtrip).unwrap()
    );
}
