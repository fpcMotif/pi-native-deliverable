...
# It seems I applied the patch multiple times when I re-ran the script or I ran the script and left the old test code in there. Let's fix it by completely replacing the test module.

# First, checkout the file to reset to clean state
import subprocess
subprocess.run(["git", "checkout", "crates/pi-session/src/lib.rs"])
